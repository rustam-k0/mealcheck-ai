...
TEXTS = {
 "EN": {
  ...
  "ERR_STATE":"This meal is no longer available. Send it again.", "ERR_MODEL_RESPONSE":"I couldn't read the nutrition result. Please try again.", "ERR_SAFETY":"The provider couldn't process this request. Try a simpler food description.",
 ...
 "RU": {
  ...
  "ERR_STATE":"Данные этого приёма пищи потерялись. Пришли его ещё раз.", "ERR_MODEL_RESPONSE":"Не удалось разобрать результат расчёта. Попробуй ещё раз.", "ERR_SAFETY":"Провайдер не смог обработать запрос. Попробуй описать еду проще.",
