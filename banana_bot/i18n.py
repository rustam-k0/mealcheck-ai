...
TEXTS = {
 "EN": {
  ...
  "WELCOME":"Hi! I’m Banana Mate 🍌\n\nSend a food photo or describe your meal in text or voice. First I’ll clarify the items and portions; after you confirm them, I’ll estimate calories and macros.",
  ...
  "SETTINGS_TEXT":"Settings. The current model is: {model}", "MODEL_PROMPT":"Choose an allowed model:", "MODEL_SET":"Model selected: {model}",
 ...
 "RU": {
  ...
  "WELCOME":"Привет! Я Banana Mate 🍌\n\nПришлите фото еды или опишите прием пищи текстом/голосом. Сначала я уточню состав и порции, затем после вашего подтверждения оценю калории и БЖУ.",
  ...
  "SETTINGS_TEXT":"Настройки. Текущая модель: {model}", "MODEL_PROMPT":"Выберите разрешенную модель:", "MODEL_SET":"Выбрана модель: {model}",
